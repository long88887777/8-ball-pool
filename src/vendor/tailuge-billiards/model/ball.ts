...
// Modified for 8-ball-pool: use a no-op BallMesh shim so the GPL physics
// model can run inside the Phaser 2D renderer without upstream Three.js meshes.
import { BallMesh } from "../shims/ballmesh"
