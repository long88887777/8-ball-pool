...
const COPY: Record<Language, GameCopy> = {
  en: {
    ...
    message: {
      ...
      eightBallReady: 'Player {player}: drag on the table to aim. Release to shoot.',
      eightBallShotInMotion: 'Shot in motion.',
      eightBallGroupsAssigned: 'Player {player} takes {group} and shoots again.',
      eightBallKeepTurn: 'Player {player} made a legal ball and shoots again.',
      eightBallTurnPass: 'No ball made. Player {player} shoots.',
      eightBallFoul: 'Foul: {reason}. Player {player} has ball in hand.',
      eightBallTimeoutFoul: 'Shot clock expired. Player {player} has ball in hand.',
      eightBallBallInHand: 'Player {player}: place the cue ball, then shoot.',
      eightBallWin: 'Player {winner} wins.',
      eightBallLoss: 'Player {loser} loses. Player {winner} wins.',
    },
  },
  zh: {
    ...
    message: {
      ...
      eightBallReady: '玩家 {player}：在球桌上拖动瞄准，松开击球。',
      eightBallShotInMotion: '击球进行中。',
      eightBallGroupsAssigned: '玩家 {player} 分到{group}，继续击球。',
      eightBallKeepTurn: '玩家 {player} 合法进球，继续击球。',
      eightBallTurnPass: '未进球，玩家 {player} 击球。',
      eightBallFoul: '犯规：{reason}，玩家 {player} 获得自由球。',
      eightBallTimeoutFoul: '击球超时，玩家 {player} 获得自由球。',
      eightBallBallInHand: '玩家 {player}：摆放白球后击球。',
      eightBallWin: '玩家 {winner} 获胜。',
      eightBallLoss: '玩家 {loser} 输掉本局，玩家 {winner} 获胜。',
    },
  },
};
